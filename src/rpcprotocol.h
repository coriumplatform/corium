...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Corium is not connected
    ...
    RPC_WALLET_PASSCORIUMASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
