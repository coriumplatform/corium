...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Corium features */
        {"corium", "masternode", &masternode, true, true, false},
        {"corium", "listmasternodes", &listmasternodes, true, true, false},
        {"corium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"corium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"corium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"corium", "masternodedebug", &masternodedebug, true, true, false},
        {"corium", "startmasternode", &startmasternode, true, true, false},
        {"corium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"corium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"corium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"corium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"corium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"corium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"corium", "mnbudget", &mnbudget, true, true, false},
        {"corium", "preparebudget", &preparebudget, true, true, false},
        {"corium", "submitbudget", &submitbudget, true, true, false},
        {"corium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"corium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"corium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"corium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"corium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"corium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"corium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"corium", "checkbudgets", &checkbudgets, true, true, false},
        {"corium", "mnsync", &mnsync, true, true, false},
        {"corium", "spork", &spork, true, true, false},
        {"corium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"corium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use coriumd, or the -server option to corium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> corium-cli " + methodname + " " + args + "\n";
}
