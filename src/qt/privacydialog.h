...
public:
    ...
    void setZCoriumControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzMLDN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzMLDN_clicked();
    void on_pushButtonZCoriumControl_clicked();
