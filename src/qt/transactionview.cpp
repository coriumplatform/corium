                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Corium from zMLDN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMLDN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMLDN));
