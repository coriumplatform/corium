                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Corium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Corium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and corium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMLDN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Corium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Corium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Corium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Corium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Corium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Corium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Corium Core help message to get a list with possible Corium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Corium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Corium network", "", count));
}
...
{
    QString strTitle = tr("Corium Core"); // default title
...
/** Creates context menu, its actions, and coriums up all the relevant signals for mouse events. */
