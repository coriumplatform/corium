...
/** Utility functions used by the Corium Qt UI.
 */
namespace GUIUtil
{
...
// Render Corium addresses in monospace font
...
// Parse "corium:" URI into recipient object, return true on successful parsing
