...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000032890e3f2fb0b90da8c090b674dbc6b2a8ca40356bc3cf704227ae4a5e3"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1530965834, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 17999;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Corium starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // Corium: 30 Seconds not used
        nTargetSpacingSlowLaunch = 1 * 60;  // Corium: 1 minute (Slow launch)
        nTargetSpacing = 1 * 30;  // Corium: 30 Seconds
        nMaturity = 49;
        ...
        const char* pszTimestamp = "corium 1530965834";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1530965834;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 476554;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000032890e3f2fb0b90da8c090b674dbc6b2a8ca40356bc3cf704227ae4a5e3"));
        assert(genesis.hashMerkleRoot == uint256("0x77698dfaffaf290b1057b90df426c17c7efb0c4ad20d0975faf663e1e77c65f1"));

    	vSeeds.push_back(CDNSSeedData("140.82.36.174", "140.82.36.174"));           // seed1
        vSeeds.push_back(CDNSSeedData("95.179.163.98", "95.179.163.98"));           // seed2
    	vSeeds.push_back(CDNSSeedData("209.250.238.237", "209.250.238.237"));       // seed3
        vSeeds.push_back(CDNSSeedData("80.240.28.52", "80.240.28.52"));             // seed4
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Corium: 1 day
        nTargetSpacing = 1 * 60;  // Corium: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet corium addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet corium script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet corium BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet corium BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet corium BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Corium: 1 day
        nTargetSpacing = 1 * 60;        // Corium: 1 minutes
