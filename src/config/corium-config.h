/* src/config/corium-config.h.  Generated from corium-config.h.in by configure.  */
/* src/config/corium-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CORIUM_CONFIG_H

#define CORIUM_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.corium.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Corium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Corium Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "corium"
