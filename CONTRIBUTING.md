Contributing to Corium Core
============================

The Corium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Corium Core project, and is not to be
confused with overall Corium Network Protocol consensus changes.

Whether a pull request is merged into Corium Core rests with the project merge
...
Patches that change Corium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Corium consensus, it must have been
...
The project leader is the release manager for each Corium Core release.
