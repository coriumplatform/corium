...
RESOURCES += src/qt/corium.qrc src/qt/corium_locale.qrc

TRANSLATIONS += src/qt/locale/corium_bg.ts \
                src/qt/locale/corium_de.ts \
                src/qt/locale/corium_en.ts \
                src/qt/locale/corium_es.ts \
                src/qt/locale/corium_fi.ts \
                src/qt/locale/corium_fr.ts \
                src/qt/locale/corium_it.ts \
                src/qt/locale/corium_ja.ts \
                src/qt/locale/corium_pl.ts \
                src/qt/locale/corium_pt.ts \
                src/qt/locale/corium_ru.ts \
                src/qt/locale/corium_sk.ts \
                src/qt/locale/corium_sv.ts \
                src/qt/locale/corium_vi.ts \
                src/qt/locale/corium_zh_CN.ts \
                src/qt/locale/corium_zh_TW.ts
